        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-foreground">{t('publicExams')}</h1>
                <p className="text-sm text-muted-foreground">{t('browseExamsDescription')}</p>
              </div>
            </div>
            <Link href="/join">
              <NeuButton>{t('enterRoomCode')}</NeuButton>
            </Link>
          </div>
        </div>
      </header>
                  ...
                  <div className="mt-auto pt-4 border-t border-border/50">
                    <div className="flex items-center justify-between">
                      ...
                      <Link href={exam.room_code ? `/join?code=${exam.room_code}` : '#'}>
                        <NeuButton size="sm" disabled={!exam.room_code}>{t('takeExam')}</NeuButton>
                      </Link>
                    </div>
                  </div>
                </NeuCard>
