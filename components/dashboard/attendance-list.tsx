        ...
        <Dialog>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <form onSubmit={handleCreateSession} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="distance">Max Distance (meters)</Label>
                  <NeuInput
                    id="distance"
                    type="number"
                    value={newSession.max_distance_meters}
                    onChange={(e) => setNewSession({ ...newSession, max_distance_meters: parseInt(e.target.value) })}
                    min="10"
                    max="500"
                  />
                </div>
                ...
                <div>
                  <Label htmlFor="refresh">QR Refresh (seconds)</Label>
                  <NeuInput
                    id="refresh"
                    type="number"
                    value={newSession.qr_refresh_interval}
                    onChange={(e) => setNewSession({ ...newSession, qr_refresh_interval: parseInt(e.target.value) })}
                    min="10"
                    max="60"
                  />
                </div>
