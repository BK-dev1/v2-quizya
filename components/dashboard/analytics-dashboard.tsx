    ...
    <div className="min-h-screen  p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="">Track your exam performance and student engagement</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <NeuCard className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm ">Total Exams</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <NeuCard className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold ">Recent Exam Performance</h3>
            </div>
                ...
                {analytics.recentExams.map((exam, index) => (
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-slate-50">
                    <div className="flex-1">
                      ...
                      <p className="text-sm ">
                        {exam.sessions} attempts • Created {exam.date}
                      </p>
                    </div>
